...
intellisense.annotate(_object, {
  ...
  'progress': function() {
    ...
    ///   <param name="progressCallbacks" type="">A function, or array of functions, to be called when the Deferred geneStankinQuestionnaire progress notifications.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'promise': function() {
